...
import brouser_java_fx_menu_e_submenu.Browser_Java_FX_Menu_01;
import brouser_java_fx_menu_e_submenu.Browser_Java_FX_Submenu_01;
 
/** 
 *
 * @author NewUser
 */
public class BrowserFX_00_Main extends JApplet {
    ...
    public void init() {
        ...
        Home.adicionar_Menu(new Browser_Java_FX_Menu_01( Home ).Barra_Menu );
        Home.adicionar_SubMenu(new Browser_Java_FX_Submenu_01( Home ) );
    ...
    public static void main(String[] args) {
        ...
        JApplet applet = new BrowserFX_00_Main();
        applet.init();
